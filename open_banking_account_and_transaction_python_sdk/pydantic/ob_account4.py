...
from open_banking_account_and_transaction_python_sdk.pydantic.ob_account4_account import OBAccount4Account
...
class OBAccount4(BaseModel):
    ...
    account: typing.Optional[OBAccount4Account] = Field(None, alias='Account')
