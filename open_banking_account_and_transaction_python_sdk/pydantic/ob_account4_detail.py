...
from open_banking_account_and_transaction_python_sdk.pydantic.ob_account4_detail_account import OBAccount4DetailAccount
...
class OBAccount4Detail(BaseModel):
    account: OBAccount4DetailAccount = Field(alias='Account')
