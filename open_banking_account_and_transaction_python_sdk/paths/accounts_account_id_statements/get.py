...
from open_banking_account_and_transaction_python_sdk.model.ob_read_statement2 import OBReadStatement2 as OBReadStatement2Schema
...
from open_banking_account_and_transaction_python_sdk.type.ob_read_statement2 import OBReadStatement2
...
from open_banking_account_and_transaction_python_sdk.pydantic.ob_read_statement2 import OBReadStatement2 as OBReadStatement2Pydantic

from . import path

# Query params
FromStatementDateTimeSchema = schemas.DateTimeSchema
ToStatementDateTimeSchema = schemas.DateTimeSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fromStatementDateTime': typing.Union[FromStatementDateTimeSchema, str, datetime, ],
        'toStatementDateTime': typing.Union[ToStatementDateTimeSchema, str, datetime, ],
    },
    total=False
)
...
request_query_from_statement_date_time = api_client.QueryParameter(
    name="fromStatementDateTime",
    style=api_client.ParameterStyle.FORM,
    schema=FromStatementDateTimeSchema,
    explode=True,
)
request_query_to_statement_date_time = api_client.QueryParameter(
    name="toStatementDateTime",
    style=api_client.ParameterStyle.FORM,
    schema=ToStatementDateTimeSchema,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = OBReadStatement2Schema
SchemaFor200ResponseBodyApplicationJosejwe = OBReadStatement2Schema
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = OBReadStatement2Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_mapped_args(
        ...
        from_statement_date_time: typing.Optional[datetime] = None,
        to_statement_date_time: typing.Optional[datetime] = None,
        ...
        if from_statement_date_time is not None:
            _query_params["fromStatementDateTime"] = from_statement_date_time
        if to_statement_date_time is not None:
            _query_params["toStatementDateTime"] = to_statement_date_time
    ...
    async def _aget_oapg(
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_from_statement_date_time,
            request_query_to_statement_date_time,
        ):
        ...
        request_before_hook(
            ...
            path_template='/accounts/{AccountId}/statements',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Get(BaseApi):
    ...
    async def aget(
        ...
        **kwargs,
        ...
        if validate:
            return OBReadStatement2Pydantic(**raw_response.body)
        return api_client.construct_model_instance(OBReadStatement2Pydantic, raw_response.body)
