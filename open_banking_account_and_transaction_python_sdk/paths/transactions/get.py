...
from open_banking_account_and_transaction_python_sdk.model.ob_read_transaction6 import OBReadTransaction6 as OBReadTransaction6Schema
...
from open_banking_account_and_transaction_python_sdk.type.ob_read_transaction6 import OBReadTransaction6
...
from open_banking_account_and_transaction_python_sdk.pydantic.ob_read_transaction6 import OBReadTransaction6 as OBReadTransaction6Pydantic
...
class BaseApi(api_client.Api):
    ...
    def _get_details_1_mapped_args(
        self,
    ...
    async def _aget_details_1_oapg(
        self,
...
class GetDetails1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_details_1(
        self,
        x_fapi_auth_date: typing.Optional[str] = None,
        x_fapi_customer_ip_address: typing.Optional[str] = None,
        x_fapi_interaction_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_details_1_mapped_args(
        ...
        return await self._aget_details_1_oapg(
    ...
    def get_details_1(
        ...
        return self._get_details_1_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetDetails1(BaseApi):
    ...
    async def aget_details_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_details_1(
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
            x_customer_user_agent=x_customer_user_agent,
    ...
    def get_details_1(
        ...
        raw_response = self.raw.get_details_1(
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
            x_customer_user_agent=x_customer_user_agent,
