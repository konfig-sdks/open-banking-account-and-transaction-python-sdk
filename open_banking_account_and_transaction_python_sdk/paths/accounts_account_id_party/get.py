...
from open_banking_account_and_transaction_python_sdk.model.ob_read_party2 import OBReadParty2 as OBReadParty2Schema

from open_banking_account_and_transaction_python_sdk.type.ob_error_response1 import OBErrorResponse1
from open_banking_account_and_transaction_python_sdk.type.ob_read_party2 import OBReadParty2
...
from open_banking_account_and_transaction_python_sdk.pydantic.ob_read_party2 import OBReadParty2 as OBReadParty2Pydantic
...
SchemaFor200ResponseBodyApplicationJson = OBReadParty2Schema
SchemaFor200ResponseBodyApplicationJosejwe = OBReadParty2Schema
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = OBReadParty2Schema
    ...
    async def _aget_by_account_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{AccountId}/party',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByAccountId(BaseApi):
    ...
    async def aget_by_account_id(
        ...
        **kwargs,
        ...
        if validate:
            return OBReadParty2Pydantic(**raw_response.body)
        return api_client.construct_model_instance(OBReadParty2Pydantic, raw_response.body)
