...
from open_banking_account_and_transaction_python_sdk.model.ob_read_offer1 import OBReadOffer1 as OBReadOffer1Schema

from open_banking_account_and_transaction_python_sdk.type.ob_error_response1 import OBErrorResponse1
from open_banking_account_and_transaction_python_sdk.type.ob_read_offer1 import OBReadOffer1
...
from open_banking_account_and_transaction_python_sdk.pydantic.ob_read_offer1 import OBReadOffer1 as OBReadOffer1Pydantic
...
XFapiInteractionIdSchema = schemas.StrSchema
SchemaFor200ResponseBodyApplicationJson = OBReadOffer1Schema
SchemaFor200ResponseBodyApplicationJosejwe = OBReadOffer1Schema
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = OBReadOffer1Schema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{AccountId}/offers',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return OBReadOffer1Pydantic(**raw_response.body)
        return api_client.construct_model_instance(OBReadOffer1Pydantic, raw_response.body)
