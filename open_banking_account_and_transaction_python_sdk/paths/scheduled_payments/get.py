...
from open_banking_account_and_transaction_python_sdk.model.ob_read_scheduled_payment3 import OBReadScheduledPayment3 as OBReadScheduledPayment3Schema

from open_banking_account_and_transaction_python_sdk.type.ob_error_response1 import OBErrorResponse1
from open_banking_account_and_transaction_python_sdk.type.ob_read_scheduled_payment3 import OBReadScheduledPayment3
...
from open_banking_account_and_transaction_python_sdk.pydantic.ob_read_scheduled_payment3 import OBReadScheduledPayment3 as OBReadScheduledPayment3Pydantic
    ...
    async def _aget_all_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/scheduled-payments',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_0(
        self,
        x_fapi_auth_date: typing.Optional[str] = None,
        x_fapi_customer_ip_address: typing.Optional[str] = None,
        x_fapi_interaction_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_0_mapped_args(
        ...
        return await self._aget_all_0_oapg(
    ...
    def get_all_0(
        ...
        return self._get_all_0_oapg(
            header_params=args.header,
        )

class GetAll0(BaseApi):
    ...
    async def aget_all_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_0(
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
            x_customer_user_agent=x_customer_user_agent,
    ...
    def get_all_0(
        ...
        raw_response = self.raw.get_all_0(
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
            x_customer_user_agent=x_customer_user_agent,
