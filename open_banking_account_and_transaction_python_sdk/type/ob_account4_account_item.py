...
class RequiredOBAccount4AccountItem(TypedDict):
    Identification: Identification0

    # Name of the identification scheme, in a coded form as published in an external list.
    SchemeName: str

class OptionalOBAccount4AccountItem(TypedDict, total=False):
    Name: Name0

    SecondaryIdentification: SecondaryIdentification

class OBAccount4AccountItem(RequiredOBAccount4AccountItem, OptionalOBAccount4AccountItem):
    pass
