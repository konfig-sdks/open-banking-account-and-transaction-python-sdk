...
class RequiredOBAccount4DetailAccountItem(TypedDict):
    Identification: Identification0

    # Name of the identification scheme, in a coded form as published in an external list.
    SchemeName: str

class OptionalOBAccount4DetailAccountItem(TypedDict, total=False):
    Name: Name0

    SecondaryIdentification: SecondaryIdentification

class OBAccount4DetailAccountItem(RequiredOBAccount4DetailAccountItem, OptionalOBAccount4DetailAccountItem):
    pass
