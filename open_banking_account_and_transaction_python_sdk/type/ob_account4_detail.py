...
from open_banking_account_and_transaction_python_sdk.type.ob_account4_detail_account import OBAccount4DetailAccount
...
class RequiredOBAccount4Detail(TypedDict):
...
class OptionalOBAccount4Detail(TypedDict, total=False):
...
class OBAccount4Detail(RequiredOBAccount4Detail, OptionalOBAccount4Detail):
    pass
