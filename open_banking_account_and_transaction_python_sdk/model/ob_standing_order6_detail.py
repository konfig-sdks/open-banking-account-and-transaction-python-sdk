...
class OBStandingOrder6Detail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "CreditorAccount", "Frequency", "CreditorAgent", "FinalPaymentAmount", "FinalPaymentDateTime", "FirstPaymentAmount", "FirstPaymentDateTime", "LastPaymentAmount", "LastPaymentDateTime", "NextPaymentAmount", "NextPaymentDateTime", "NumberOfPayments", "Reference", "StandingOrderId", "StandingOrderStatusCode", "SupplementaryData", ], str]):
