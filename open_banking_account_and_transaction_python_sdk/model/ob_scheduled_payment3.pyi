...
class OBScheduledPayment3(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "InstructedAmount", "ScheduledPaymentDateTime", "ScheduledType", "CreditorAccount", "CreditorAgent", "DebtorReference", "Reference", "ScheduledPaymentId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "InstructedAmount", "ScheduledPaymentDateTime", "ScheduledType", "CreditorAccount", "CreditorAgent", "DebtorReference", "Reference", "ScheduledPaymentId", ], str]):
