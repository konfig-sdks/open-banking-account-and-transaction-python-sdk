...
class OBScheduledPayment3Detail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "CreditorAccount", "InstructedAmount", "ScheduledPaymentDateTime", "ScheduledType", "CreditorAgent", "DebtorReference", "Reference", "ScheduledPaymentId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "CreditorAccount", "InstructedAmount", "ScheduledPaymentDateTime", "ScheduledType", "CreditorAgent", "DebtorReference", "Reference", "ScheduledPaymentId", ], str]):
