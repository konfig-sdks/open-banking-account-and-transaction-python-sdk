...
class OBAccount6Basic(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "AccountSubType", "AccountType", "Currency", "Description", "MaturityDate", "Nickname", "OpeningDate", "Status", "StatusUpdateDateTime", "SwitchStatus", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "AccountSubType", "AccountType", "Currency", "Description", "MaturityDate", "Nickname", "OpeningDate", "Status", "StatusUpdateDateTime", "SwitchStatus", ], str]):
