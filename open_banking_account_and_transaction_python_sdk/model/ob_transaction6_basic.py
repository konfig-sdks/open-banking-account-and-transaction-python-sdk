...
class OBTransaction6Basic(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "Amount", "BookingDateTime", "CreditDebitIndicator", "Status", "AddressLine", "BankTransactionCode", "CardInstrument", "ChargeAmount", "CurrencyExchange", "ProprietaryBankTransactionCode", "StatementReference", "SupplementaryData", "TransactionId", "TransactionMutability", "TransactionReference", "ValueDateTime", ], str]):
