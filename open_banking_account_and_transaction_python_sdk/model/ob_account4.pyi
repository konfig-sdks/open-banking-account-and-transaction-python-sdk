...
class OBAccount4(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Account() -> typing.Type['OBAccount4Account']:
                return OBAccount4Account
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Account"]) -> 'OBAccount4Account': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "AccountSubType", "AccountType", "Currency", "Account", "Description", "Nickname", "Servicer", "Status", "StatusUpdateDateTime", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Account"]) -> typing.Union['OBAccount4Account', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "AccountSubType", "AccountType", "Currency", "Account", "Description", "Nickname", "Servicer", "Status", "StatusUpdateDateTime", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        AccountType: 'OBExternalAccountType1Code',
        AccountSubType: 'OBExternalAccountSubType1Code',
        Account: typing.Union['OBAccount4Account', schemas.Unset] = schemas.unset,
