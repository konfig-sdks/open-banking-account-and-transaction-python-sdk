...
class OBCashAccount61(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Identification", "Name", "SchemeName", "SecondaryIdentification", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Identification", "Name", "SchemeName", "SecondaryIdentification", ], str]):
