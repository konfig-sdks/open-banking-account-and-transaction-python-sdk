...
class OBBeneficiary5Detail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["CreditorAccount", "AccountId", "BeneficiaryId", "BeneficiaryType", "CreditorAgent", "Reference", "SupplementaryData", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CreditorAccount", "AccountId", "BeneficiaryId", "BeneficiaryType", "CreditorAgent", "Reference", "SupplementaryData", ], str]):
